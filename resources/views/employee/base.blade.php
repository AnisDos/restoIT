...
<!-- Mirrored from slidesigma.com/themes/html/costic/{{ url('employee') }} by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:47:11 GMT -->
<head>
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="{{ url('employee') }}">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
          <li> <a href="{{ url('employee') }}">Costic</a>
          </li>
        </ul>
      </li>
      <!-- /Dashboard -->
...
@if ($privilege->privilegeName == "stocks")
        <!-- tomatich product -->
        <li class="menu-item">
            <a href="#" class="has-chevron" data-toggle="collapse" data-target="#product1{{$privilege->privilegeName}}" aria-expanded="false" aria-controls="product1{{$privilege->privilegeName}}"> <span><i class="fa fa-archive fs-16"></i>{{$privilege->privilegeName}} </span>
            </a>
            <ul id="product1{{$privilege->privilegeName}}" class="collapse" aria-labelledby="product1{{$privilege->privilegeName}}" data-parent="#side-nav-accordion">
             
      
              <li> <a href="{{ url('employee/tomatich') }}">Add {{$privilege->privilegeName}}</a>
              </li>
...
@if ($privilege->privilegeName == "stocks")
        ...
        <li class="menu-item">
            ...
            <ul id="product1{{$privilege->privilegeName}}" class="collapse" aria-labelledby="product1{{$privilege->privilegeName}}" data-parent="#side-nav-accordion">
              ...
              <li> <a href="{{ url('employee/stocks/versionProduct') }}">Add Product</a>
              </li>
              <li> <a href="{{ url('employee/stocks/UpdateQnttToProduct') }}">Update Qnt to Product</a>
              </li>
            </ul>
          </li>
          <!-- stock product end -->
...
<li class="menu-item">
    ...
    <ul id="product1{{$privilege->privilegeName}}" class="collapse" aria-labelledby="product1{{$privilege->privilegeName}}" data-parent="#side-nav-accordion">
      ...
      <li> <a href="{{ url('employee/stocks') }}">Add {{$privilege->privilegeName}}</a>
      </li>
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="{{ url('employee') }}"><img src="{{  asset ('styleRestoIT/assets/img/costic/costic-logo-84x41.png') }}" alt="logo"> </a>
      </div>
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="ms-user-img ms-img-round float-right" src="/storage/{{Auth::user()->employee->image}}" alt="people">
          </a>
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            ...
            <li class="ms-dropdown-list">
              <a class="media fs-14 p-2" href="{{ url('employee') }}"> <span><i class="flaticon-user mr-2"></i> {{__('Profile')}}</span>
              </a>

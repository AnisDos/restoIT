...
@if ($privilege->id == 1)
        <!-- tomatich product -->
        <li class="menu-item">
            <a href="#" class="has-chevron" data-toggle="collapse" data-target="#product1{{$privilege->id}}" aria-expanded="false" aria-controls="product1{{$privilege->id}}"> <span><i class="fa fa-archive fs-16"></i>{{$privilege->privilegeName}} </span>
            </a>
            <ul id="product1{{$privilege->id}}" class="collapse" aria-labelledby="product1{{$privilege->id}}" data-parent="#side-nav-accordion">
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="{{ url('employee') }}"><img src="assets/img/costic/costic-logo-84x41.png" alt="logo"> </a>
      </div>
...
<!-- Mirrored from slidesigma.com/themes/html/costic/{{ url('employee') }} by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:48:09 GMT -->
</html>

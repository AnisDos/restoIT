...
<body class="ms-body ms-primary-theme">
  ...
  <main class="body-content ms-coming-soon">
    ...
    <h1>Welcome <?php echo e(Auth::user()->name); ?></h1>
      ...
      <h3> you can now check your Admin Panel<a href=" <?php echo e(url('admin')); ?> " ><h3 style="color:red" >here</h3></a>  </h3>
      
      <?php else: ?> 
      
      <h3> you can now check your Restaurant Panel<a href=" <?php echo e(url('restaurant')); ?> " ><h3 style="color:red" >here</h3></a> </h3>
      <?php endif; ?>
      </div>
      <ul class="ms-list-flex ms-social-container">
        ...
        <li>    <a class="media fs-14 p-2" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
 ...
 <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
  ...
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/jquery.countdown.min.js')); ?>">
  </script>
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/coming-soon.js')); ?>"></script>
...
<!-- Mirrored from slidesigma.com/themes/html/costic/pages/prebuilt-pages/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:51:12 GMT -->
</html><?php /**PATH D:\laravelAnis\restoIT\resources\views/home.blade.php ENDPATH**/ ?>
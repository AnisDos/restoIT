...
<!-- Mirrored from slidesigma.com/themes/html/costic/<?php echo e(url('restaurant')); ?> by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:47:11 GMT -->
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset ('styleRestoIT/vendors/iconic-fonts/cryptocoins/cryptocoins.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset ('styleRestoIT/vendors/iconic-fonts/cryptocoins/cryptocoins-colors.css')); ?>">
  <!-- Bootstrap core CSS -->
  ...
  <link href="<?php echo e(asset ('styleRestoIT/assets/css/slick.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset ('styleRestoIT/assets/css/datatables.min.css')); ?>" rel="stylesheet">
  <!-- Costic styles -->
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="<?php echo e(url('restaurant')); ?>">
        <img src="<?php echo e(asset ('styleRestoIT/assets/img/costic/costic-logo-216x62.png')); ?>" alt="logo">
      </a>
    </div>
    <!-- Navigation -->
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        ...
        <li class="ms-nav-item dropdown"> <a href="#" class="text-disabled <?php if($productNoQnt): ?> ms-has-notification <?php endif; ?>" id="notificationDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flaticon-bell"></i></a>
          <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="notificationDropdown">
            <li class="dropdown-menu-header">
              <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Notifications</span></h6><span class="badge badge-pill badge-info"><?php echo e(count($productNoQnt)); ?> New</span>
            </li>
            ...
            <li class="ms-scrollable ms-dropdown-list">
              ...
              <a class="media p-2" href="/restaurant/purchaseOrder/<?php echo e($prod->id); ?>">
                <div class="media-body"> <span> Inventory shortage <strong> <?php echo e($prod->productName); ?> </strong> go check it</span>
    ...
    console.log(valueSelected);
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="ms-user-img ms-img-round float-right" src="/storage/<?php echo e(Auth::user()->restaurant->image); ?>" alt="people">
          </a>
...
<!-- /page content -->
  ...
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/Chart.bundle.min.js')); ?>">
  </script>
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/widgets.js')); ?>"> </script>
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/clients.js')); ?>"> </script>
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/Chart.Financial.js')); ?>"> </script>
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/d3.v3.min.js')); ?>">
  </script>
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/topojson.v1.min.js')); ?>">
  </script>
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/datatables.min.js')); ?>">
  </script>
  <script src="<?php echo e(asset ('styleRestoIT/assets/js/data-tables.js')); ?>">
  </script>
...
<!-- Mirrored from slidesigma.com/themes/html/costic/<?php echo e(url('restaurant')); ?> by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:48:09 GMT -->
</html>
<?php /**PATH D:\laravelAnis\restoIT\resources\views/restaurant/base.blade.php ENDPATH**/ ?>
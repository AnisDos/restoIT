...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="<?php echo e(url('superadmin')); ?>">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
          <li> <a href="<?php echo e(url('superadmin')); ?>">innovar</a>
          </li>
        </ul>
      </li>
      <!-- /Dashboard -->
         ...
         <li class="menu-item">
          ...
          <ul id="basic-elements" class="collapse" aria-labelledby="basic-elements" data-parent="#side-nav-accordion">
            <li> <a href="<?php echo e(url('superadmin/generatekey')); ?>">Generate Key</a>
            </li>
          
             <li> <a href="<?php echo e(url('superadmin/showRestaurantAllInfo')); ?>">All Admins </a>
            </li>
          </ul>
        </li>
        <!-- /Basic UI Elements -->
     ...
     <li class="menu-item">
      ...
      <ul id="invoice" class="collapse" aria-labelledby="invoice" data-parent="#side-nav-accordion">
        ...
        <li> <a href="<?php echo e(url('superadmin/showRevenu')); ?>">showRevenu</a>
        </li>   
           <li> <a href="<?php echo e(url('superadmin/showtotalecompte')); ?>">showtotalecompte</a>
        </li>
      </ul>
    </li>
    <!-- charge end -->
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="<?php echo e(url('superadmin')); ?>"><img src="<?php echo e(asset ('styleRestoIT/assets/img/costic/costic-logo-84x41.png')); ?>" alt="logo"> </a>
      </div>
...
console.log(valueSelected);
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="ms-user-img ms-img-round float-right" src="/storage/<?php echo e(Auth::user()->superadmin->image); ?>" alt="people">
          </a>
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            ...
            <a class="media fs-14 p-2" href="/superadmin/accountsettings/<?php echo e(Auth::user()->superadmin->id); ?>"> <span><i class="flaticon-gear mr-2"></i> Account Settings</span>
              </a>
            </li>
            <li class="dropdown-divider"></li>
...
<!-- Mirrored from slidesigma.com/themes/html/costic/<?php echo e(url('superadmin')); ?> by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:48:09 GMT -->
</html>
<?php /**PATH D:\laravelAnis\restoIT\resources\views/superadmin/base.blade.php ENDPATH**/ ?>
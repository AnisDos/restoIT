...
<!-- Mirrored from slidesigma.com/themes/html/costic/<?php echo e(url('employee')); ?> by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:47:11 GMT -->
<head>
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="<?php echo e(url('employee')); ?>">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
          <li> <a href="<?php echo e(url('employee')); ?>">Costic</a>
          </li>
        </ul>
      </li>
      <!-- /Dashboard -->
...
<?php if($privilege->privilegeName == "stocks"): ?>
        ...
        <li class="menu-item">
            ...
            <ul id="product1<?php echo e($privilege->privilegeName); ?>" class="collapse" aria-labelledby="product1<?php echo e($privilege->privilegeName); ?>" data-parent="#side-nav-accordion">
              ...
              <li> <a href="<?php echo e(url('employee/stocks/UpdateQnttToProduct')); ?>">Update Qnt to Product</a>
              </li>
            </ul>
          </li>
          <!-- stock product end -->

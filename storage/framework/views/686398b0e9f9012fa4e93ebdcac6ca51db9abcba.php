...
<!-- Mirrored from slidesigma.com/themes/html/costic/<?php echo e(url('admin')); ?> by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:47:11 GMT -->
<head>
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="<?php echo e(url('admin')); ?>">
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="advanced-elements" class="collapse" aria-labelledby="advanced-elements" data-parent="#side-nav-accordion">
          <li> <a href="<?php echo e(url('admin/addRestaurant')); ?>">Add Restaurant</a>
          </li>
          <li> <a href="<?php echo e(url('admin/restaurantsList')); ?>">Restaurant List</a>
          </li>
...
<?php $__currentLoopData = $privileges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $privilege): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <li class="menu-item">
        ...
        <ul id="product" class="collapse" aria-labelledby="product" data-parent="#side-nav-accordion">
          ...
          <li> <a href="<?php echo e(url('admin/mealsList')); ?>">Meals List</a>
          </li>
       
          <li> <a href="<?php echo e(url('admin/addMeal')); ?>">Add Meal</a>
          </li>
      ...
      <?php if($privilege->privilegeName == "stocks"): ?>
        ...
        <ul id="product1" class="collapse" aria-labelledby="product1" data-parent="#side-nav-accordion">
          ...
          <li> <a href="<?php echo e(url('admin/addProduct')); ?>">Add Product</a>
          </li>
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="<?php echo e(url('admin')); ?>"><img src="<?php echo e(asset ('styleRestoIT/assets/img/costic/costic-logo-84x41.png')); ?>" alt="logo"> </a>
      </div>
...
<!-- Mirrored from slidesigma.com/themes/html/costic/<?php echo e(url('admin')); ?> by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:48:09 GMT -->
</html>
<?php /**PATH D:\laravelAnis\restoIT\resources\views/admin/base.blade.php ENDPATH**/ ?>
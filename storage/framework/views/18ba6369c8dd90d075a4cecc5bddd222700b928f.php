        ...
        <div class="ms-auth-col">
          <div class="ms-auth-form">
            <form method="POST" action="<?php echo e(route('login')); ?>" class="needs-validation" novalidate="">
                <?php echo csrf_field(); ?>
              <h3>Restaurant and Admin Login </h3>  
               <p class="mb-0 mt-3 text-center" >You are an Employee? <a class="btn-link" href="<?php echo e(url('employee/login')); ?>">Please Login here</a> 
...
unset($__errorArgs, $__bag); ?>
              ...
              <p class="mb-0 mt-3 text-center">Don't have an account? <a class="btn-link" href="<?php echo e(route('register')); ?>">Create Account</a> 
              </p>
            </form>
          </div>
        </div>
...
<!-- Mirrored from slidesigma.com/themes/html/costic/pages/prebuilt-pages/default-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Apr 2020 18:51:11 GMT -->
</html><?php /**PATH D:\laravelAnis\restoIT\resources\views/auth/login.blade.php ENDPATH**/ ?>
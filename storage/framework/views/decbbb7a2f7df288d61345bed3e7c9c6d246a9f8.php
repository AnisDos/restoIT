              ...
              <div id="arrowSlider" class="ms-arrow-slider carousel slide" data-ride="carousel" data-interval="false">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="/storage/<?php echo e($meal->image); ?>" alt="First slide">
...
<div class=" col-md-6">
          <div class="ms-panel ms-panel-fh">
            <div class="ms-panel-body">
              ...
              <div class="new">
                <a href="/admin/updateMeal/<?php echo e($meal->id); ?>" class="btn btn-primary">Edit</a>
...
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravelAnis\restoIT\resources\views/admin/mealDetails.blade.php ENDPATH**/ ?>
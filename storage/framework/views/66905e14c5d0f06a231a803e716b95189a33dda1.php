        ...
        <div class="col-xl-6 col-md-12">
          <div class="ms-panel ms-panel-fh">
            ...
            <div class="ms-panel-body">
              <form onsubmit="return submitForm();" id="ratinoupikamila" method="POST"  action="<?php echo e(url('admin/addMealForm')); ?>" enctype="multipart/form-data" class="needs-validation clearfix" novalidate>
...
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravelAnis\restoIT\resources\views/admin/addMeal.blade.php ENDPATH**/ ?>
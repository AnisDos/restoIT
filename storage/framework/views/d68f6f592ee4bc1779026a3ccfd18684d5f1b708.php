...
(function($) {
  'use strict';
   ...
   "<?php echo e($employee->type); ?>",
    ...
    "<a href='/restaurant/checkEmployeeByOne/<?php echo e($employee->id); ?>' class='ms-btn-icon btn-success'  \
     \
     >  -></a>"],
...
<?php echo $__env->make('restaurant.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravelAnis\restoIT\resources\views/restaurant/allEmployee.blade.php ENDPATH**/ ?>